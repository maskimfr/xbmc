...
:COMPILE_CMAKE_EXE
  ...
  cmake.exe -G "Visual Studio 14 Win64" -DENABLE_AIRTUNES:BOOL=OFF -DENABLE_BLURAY:BOOL=OFF -DENABLE_CEC:BOOL=OFF -DENABLE_MYSQLCLIENT:BOOL=OFF -DENABLE_PLIST:BOOL=OFF -DENABLE_SSH:BOOL=OFF -DENABLE_XSLT:BOOL=OFF %base_dir%
  IF %errorlevel%==1 (
